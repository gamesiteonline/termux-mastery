# Welcome to Termux Mastery 🚀

<div class="animated-hero">
  <p class="hero-subtitle">Transform your Android terminal into a development powerhouse</p>
  <div class="hero-badges">
    <span class="badge">100+ Zsh Examples</span>
    <span class="badge">100+ Fish Examples</span>
    <span class="badge">100+ Bash Examples</span>
    <span class="badge">200 Automation Recipes</span>
    <span class="badge">100 Theme Gallery</span>
  </div>
</div>
...
<div class="code-block" data-animate="slide-up">
...
|-------|-----------------|
| **🐣 Beginner** | Step-by-step install guides, shell basics, what is autocomplete |
| **⚡ Intermediate** | Zsh/Fish mastery, plugin configs, Tasker automation, theming |
| **🧙 Advanced** | Custom completions, proot-distro, building packages, dotfiles |

---

## ⭐ Show Your Support

If this guide helps you, consider:
- ⭐ Starring the [GitHub repo](https://github.com/gamesiteonline/termux-mastery)
- 🐛 Reporting issues or suggesting topics
- 📝 Contributing your own examples
- 📢 Sharing with fellow Termux users
